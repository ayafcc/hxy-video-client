...
public class SpecialtTopicFragment extends BaseMainFragment {
    ...
    public void onResume() {
        ...
        if (!isInit) {
            ...
            refreshLayout.setOnRefreshListener(refreshlayout -> refreshlayout.finishRefresh(1000));

            refreshLayout.setOnLoadMoreListener(refreshLayout -> refreshLayout.finishRefresh(1000));
