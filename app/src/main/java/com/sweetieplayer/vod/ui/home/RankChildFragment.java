...
import com.sweetieplayer.vod.bean.RankBean;
import com.sweetieplayer.vod.bean.RankOrderEvent;
import com.sweetieplayer.vod.bean.UpdateEvent;
import com.sweetieplayer.vod.bean.VodBean;
import com.sweetieplayer.vod.card.RankCardItemViewBinder;
...
public class RankChildFragment extends BaseItemFragment<Type> {
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        header.setColorSchemeColors(getActivity().getResources().getColor(R.color.colorAccent));
