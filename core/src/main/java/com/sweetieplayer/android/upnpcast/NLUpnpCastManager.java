...
import com.sweetieplayer.android.upnpcast.controller.CastControlImp;
import com.sweetieplayer.android.upnpcast.controller.CastEventListenerListWrapper;
...
public class NLUpnpCastManager implements IUpnpCast
{
    ...
    public void addRegistryDeviceListener(NLDeviceRegistryListener.OnRegistryDeviceListener listener)
    {
        if (mUpnpCastService != null)
        {
    ...
    public void removeRegistryListener(NLDeviceRegistryListener.OnRegistryDeviceListener listener)
    {
