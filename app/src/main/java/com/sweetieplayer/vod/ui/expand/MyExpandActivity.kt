...
import com.sweetieplayer.vod.bean.MyExpand
import com.sweetieplayer.vod.databinding.ActivityMyExpandBinding
import com.sweetieplayer.vod.netservice.VodService
import com.sweetieplayer.vod.utils.AgainstCheatUtil
import com.sweetieplayer.vod.utils.DateUtil
...
class MyExpandActivity : BaseActivity(), View.OnClickListener, OnLoadMoreListener, OnRefreshListener {
    ...
    class ExpandAdapter(var activity: Activity) :
        BaseQuickAdapter<MyExpand.ListBean, BaseViewHolder>(R.layout.item_my_expand) {
