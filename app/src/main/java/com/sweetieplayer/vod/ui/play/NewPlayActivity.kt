...
import com.sweetieplayer.av.play.AvVideoController.RECEIVER_TYPE_REPLAY
import com.sweetieplayer.av.play.AvVideoController.RECEIVER_TYPE_TIMER
...
import com.sweetieplayer.vod.jiexi.JieXiUtils2
import com.sweetieplayer.vod.jiexi.StringUrlseek
import com.sweetieplayer.vod.netservice.VodService
import com.sweetieplayer.vod.ui.dlan.DlanListPop
        ...
        newPlayBinding.videoView.post {
            if( playFrom.player_info.parse2.contains("ikheader=") ||url.contains("mgtv.com")){
                if(playFrom.player_info.parse2.contains("ikheader=")) {
                    ...
                    //p1 = com.sweetieplayer.vod.utils.StringUtils.getSubUtil(playFrom.player_info.parse2, rgex)[0]
                    p1 = StringUrlseek.seek_header(playFrom.player_info.parse2)
                    if(avheaders==null){
